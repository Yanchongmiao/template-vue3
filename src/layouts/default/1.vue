  ...
  <a-layout style="min-height: 100vh">
    ...
    <a-layout class="flex flex-col">
      ...
      <a-layout>
        ...
        <a-layout-content class="flex flex-col flex-1" :style="contentStyle">
          ...
          <div class="flex-1" :style="contentBoxStyle">
            <router-view class="animate__animated animate__bounceInDown"></router-view>
          </div>
          <a-layout-footer
            v-if="useMenu.navMode == 2"
            style="text-align: center"
          >Admin©2021 Created by UED</a-layout-footer>
        </a-layout-content>
        <a-layout-footer
          v-if="useMenu.navMode == 1"
          style="text-align: center"
...
const contentStyle = {
  margin: useMenu.navMode == 1 ? '10px' : '',
  padding: '10px',
  background: useMenu.navMode == 2 ? '' : '#fff',
  minHeight: '280px',
}
const contentBoxStyle = {
  background: useMenu.navMode == 2 ? '#fff' : '',
  padding: useMenu.navMode == 2 ? '10px' : '',
}
</script>
